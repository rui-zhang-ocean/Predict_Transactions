...
df_input = pd.read_csv('/home/rzhang_dal/project/cc_data_input_10emb_ageCat70.csv', index_col = False)

# remove second column
df_input = df_input.drop(['Unnamed: 0'], axis=1)

# randomly sample less than 3 million records
df_input = df_input.sample(n = 500000, random_state = 1)
...
save_object(synthesizer, '/home/rzhang_dal/project/TVAE_synthesizer_10emb_noCat_ageCat70_0.5M.pkl')
